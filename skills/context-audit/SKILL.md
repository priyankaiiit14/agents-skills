...
- Estimate token bloat: flag long paragraphs, repeated examples, or likely
  >3,000 tokens even if line count is under 200
...
- Prefer moving useful detail to references/ over deleting it outright
...
Use the larger applicable threshold only: CLAUDE.md > 500 is -20 total,
not -30; Skill > 500 is -10 total, not -15. For flagged rules, round up:
1-5 flagged rules = -5, 6-10 = -10, etc. Count each contradiction pair
as -10. Floor at 0. Output this format:
